...
- [ ] Canvas 画布重构
  ...
  - [x] Visual Request Config 与消息流 → [spec](specs/visual-request-and-message-flow.md)
  ...
  - [ ] Message 选中与编辑分离 → [spec](specs/message-select-edit.md)
  - [x] 连线交互修复与增强 → [spec](specs/connection-interaction.md)
